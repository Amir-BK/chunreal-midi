...
#include "IChunrealSlateEditableTextWidget.generated.h"

struct FTextLocation;

enum class EChunrealCursorMoveMethod
{
...
enum class EChunrealCursorMoveGranularity
{
...
enum class EChunrealCursorAction
{
...
enum class EChunrealTextLocation
{
...
UENUM(BlueprintType)
enum class EChunrealVirtualKeyboardTrigger : uint8
{
...
UENUM(BlueprintType)
enum class EChunrealVirtualKeyboardDismissAction : uint8
{
...
public:
	 ...
	 */
	static FChunrealMoveCursor Cardinal(EChunrealCursorMoveGranularity Granularity, FIntPoint Direction, EChunrealCursorAction Action);
	 ...
	 * @param Action                 Just move or also select text?
	 */
	static FChunrealMoveCursor ViaScreenPointer(FVector2D LocalPosition, float GeometryScale, EChunrealCursorAction Action);

	/** @see ECursorMoveMethod */
	EChunrealCursorMoveMethod GetMoveMethod() const;
	...
	/** @see ECursorAction */
	EChunrealCursorAction GetAction() const;
	...
	EChunrealCursorMoveGranularity GetGranularity() const;

	/** Geometry Scale at the time of the event that caused this action */
	float GetGeometryScale() const;

private:
	FChunrealMoveCursor(EChunrealCursorMoveGranularity InGranularity, EChunrealCursorMoveMethod InMethod, FVector2D InDirectionOrPosition, float InGeometryScale, EChunrealCursorAction InAction);

	EChunrealCursorMoveGranularity Granularity;
	EChunrealCursorMoveMethod Method;
	FVector2f DirectionOrPosition;
	EChunrealCursorAction Action;
	float GeometryScale;
};

/** Manages the state for an active context menu */
class FChunrealActiveTextEditContextMenu
{
public:
	FChunrealActiveTextEditContextMenu()
...
class IChunrealSlateEditableTextWidget
{
public:
	...
	virtual EChunrealVirtualKeyboardTrigger GetVirtualKeyboardTrigger() const = 0;

	/** Get the message action to take when the virtual keyboard is dismissed by the user */
	virtual EChunrealVirtualKeyboardDismissAction GetVirtualKeyboardDismissAction() const = 0;
