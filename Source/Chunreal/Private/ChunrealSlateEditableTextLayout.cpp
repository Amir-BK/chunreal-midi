...
{
public:
	explicit FScopedEditableTextTransaction(FChunrealSlateEditableTextLayout& InEditableTextLayout)
...
private:
	FChunrealSlateEditableTextLayout* EditableTextLayout;
};
...
FChunrealSlateEditableTextLayout::FChunrealSlateEditableTextLayout(IChunrealSlateEditableTextWidget& InOwnerWidget, const TAttribute<FText>& InInitialText, FTextBlockStyle InTextStyle, const TOptional<ETextShapingMethod> InTextShapingMethod, const TOptional<ETextFlowDirection> InTextFlowDirection, const FCreateChunrealSlateTextLayout& InCreateSlateTextLayout, TSharedRef<ITextLayoutMarshaller> InTextMarshaller, TSharedRef<ITextLayoutMarshaller> InHintTextMarshaller)
{
	...
	UICommandList->MapAction(FGenericCommands::Get().Undo,
		FExecuteAction::CreateRaw(this, &FChunrealSlateEditableTextLayout::Undo),
		FCanExecuteAction::CreateRaw(this, &FChunrealSlateEditableTextLayout::CanExecuteUndo),
		EUIActionRepeatMode::RepeatEnabled
		);

	UICommandList->MapAction(FGenericCommands::Get().Cut,
		FExecuteAction::CreateRaw(this, &FChunrealSlateEditableTextLayout::CutSelectedTextToClipboard),
		FCanExecuteAction::CreateRaw(this, &FChunrealSlateEditableTextLayout::CanExecuteCut)
		);

	UICommandList->MapAction(FGenericCommands::Get().Paste,
		FExecuteAction::CreateRaw(this, &FChunrealSlateEditableTextLayout::PasteTextFromClipboard),
		FCanExecuteAction::CreateRaw(this, &FChunrealSlateEditableTextLayout::CanExecutePaste),
		EUIActionRepeatMode::RepeatEnabled
		);

	UICommandList->MapAction(FGenericCommands::Get().Copy,
		FExecuteAction::CreateRaw(this, &FChunrealSlateEditableTextLayout::CopySelectedTextToClipboard),
		FCanExecuteAction::CreateRaw(this, &FChunrealSlateEditableTextLayout::CanExecuteCopy)
		);

	UICommandList->MapAction(FGenericCommands::Get().Delete,
		FExecuteAction::CreateLambda(ExecuteDeleteAction),
		FCanExecuteAction::CreateRaw(this, &FChunrealSlateEditableTextLayout::CanExecuteDelete)
		);

	UICommandList->MapAction(FGenericCommands::Get().SelectAll,
		FExecuteAction::CreateRaw(this, &FChunrealSlateEditableTextLayout::SelectAllText),
		FCanExecuteAction::CreateRaw(this, &FChunrealSlateEditableTextLayout::CanExecuteSelectAll)
		);
}

FChunrealSlateEditableTextLayout::~FChunrealSlateEditableTextLayout()
{
...
void FChunrealSlateEditableTextLayout::SetText(const TAttribute<FText>& InText)
{
	...
	if (RefreshImpl(&NewText, bForceRefresh))
	{
		...
		{
			JumpTo(EChunrealTextLocation::EndOfDocument, EChunrealCursorAction::MoveCursor);
		}
...
int32 FChunrealSlateEditableTextLayout::GetTextLineCount()
{
	return TextLayout->GetLineCount();
}

FText FChunrealSlateEditableTextLayout::GetText() const
{
...
void FChunrealSlateEditableTextLayout::SetHintText(const TAttribute<FText>& InHintText)
{
	HintText = InHintText;
...
FText FChunrealSlateEditableTextLayout::GetHintText() const
{
	return HintText.Get(FText::GetEmpty());
}

void FChunrealSlateEditableTextLayout::SetSearchText(const TAttribute<FText>& InSearchText)
{
...
FText FChunrealSlateEditableTextLayout::GetSearchText() const
{
	return SearchText;
}

int32 FChunrealSlateEditableTextLayout::GetSearchResultIndex() const
{
	return CurrentSearchResultIndex;
}

int32 FChunrealSlateEditableTextLayout::GetNumSearchResults() const
{
	return SearchResultToIndexMap.Num();
}

void FChunrealSlateEditableTextLayout::SetTextStyle(const FTextBlockStyle& InTextStyle)
{
	TextStyle = InTextStyle;
...
const FTextBlockStyle& FChunrealSlateEditableTextLayout::GetTextStyle() const
{
	return TextStyle;
}

void FChunrealSlateEditableTextLayout::SetCursorBrush(const TAttribute<const FSlateBrush*>& InCursorBrush)
{
	CursorLineHighlighter->SetCursorBrush(InCursorBrush);
}

void FChunrealSlateEditableTextLayout::SetCompositionBrush(const TAttribute<const FSlateBrush*>& InCompositionBrush)
{
	TextCompositionHighlighter->SetCompositionBrush(InCompositionBrush);
}

FText FChunrealSlateEditableTextLayout::GetPlainText() const
{
	SLATE_CROSS_THREAD_CHECK();
...
bool FChunrealSlateEditableTextLayout::SetEditableText(const FText& TextToSet, const bool bForce)
{
	SLATE_CROSS_THREAD_CHECK();
...
FText FChunrealSlateEditableTextLayout::GetEditableText() const
{
	FString EditedText;
...
FText FChunrealSlateEditableTextLayout::GetSelectedText() const
{
	if (AnyTextSelected())
	{
...
FTextSelection FChunrealSlateEditableTextLayout::GetSelection() const
{
	const FTextLocation CursorInteractionPosition = CursorInfo.GetCursorInteractionLocation();
...
void FChunrealSlateEditableTextLayout::SetTextShapingMethod(const TOptional<ETextShapingMethod>& InTextShapingMethod)
{
	TextLayout->SetTextShapingMethod((InTextShapingMethod.IsSet()) ? InTextShapingMethod.GetValue() : GetDefaultTextShapingMethod());
}

void FChunrealSlateEditableTextLayout::SetTextFlowDirection(const TOptional<ETextFlowDirection>& InTextFlowDirection)
{
	TextLayout->SetTextFlowDirection((InTextFlowDirection.IsSet()) ? InTextFlowDirection.GetValue() : GetDefaultTextFlowDirection());
}

void FChunrealSlateEditableTextLayout::SetTextWrapping(const TAttribute<float>& InWrapTextAt, const TAttribute<bool>& InAutoWrapText, const TAttribute<ETextWrappingPolicy>& InWrappingPolicy)
{
...
void FChunrealSlateEditableTextLayout::SetWrapTextAt(const TAttribute<float>& InWrapTextAt)
{
	WrapTextAt = InWrapTextAt;
...
void FChunrealSlateEditableTextLayout::SetAutoWrapText(const TAttribute<bool>& InAutoWrapText)
{
	AutoWrapText = InAutoWrapText;
...
void FChunrealSlateEditableTextLayout::SetWrappingPolicy(const TAttribute<ETextWrappingPolicy>& InWrappingPolicy)
{
	WrappingPolicy = InWrappingPolicy;
...
void FChunrealSlateEditableTextLayout::SetMargin(const TAttribute<FMargin>& InMargin)
{
	Margin = InMargin;
...
void FChunrealSlateEditableTextLayout::SetJustification(const TAttribute<ETextJustify::Type>& InJustification)
{
...
void FChunrealSlateEditableTextLayout::SetLineHeightPercentage(const TAttribute<float>& InLineHeightPercentage)
{
...
void FChunrealSlateEditableTextLayout::SetApplyLineHeightToBottomLine(const TAttribute<bool>& InApplyLineHeightToBottomLine)
{
...
void FChunrealSlateEditableTextLayout::SetOverflowPolicy(TOptional<ETextOverflowPolicy> InOverflowPolicy)
{
...
void FChunrealSlateEditableTextLayout::SetDebugSourceInfo(const TAttribute<FString>& InDebugSourceInfo)
{
...
TSharedRef<IVirtualKeyboardEntry> FChunrealSlateEditableTextLayout::GetVirtualKeyboardEntry() const
{
	return VirtualKeyboardEntry.ToSharedRef();
}

TSharedRef<ITextInputMethodContext> FChunrealSlateEditableTextLayout::GetTextInputMethodContext() const
{
	return TextInputMethodContext.ToSharedRef();
}

void FChunrealSlateEditableTextLayout::EnableTextInputMethodContext()
{
...
bool FChunrealSlateEditableTextLayout::Refresh()
{
	const FText& TextToSet = BoundText.Get(FText::GetEmpty());
	return RefreshImpl(&TextToSet);
}

bool FChunrealSlateEditableTextLayout::RefreshImpl(const FText* InTextToSet, const bool bForce)
{
	SLATE_CROSS_THREAD_CHECK();
...
void FChunrealSlateEditableTextLayout::ForceRefreshTextLayout(const FText& CurrentText)
{
...
void FChunrealSlateEditableTextLayout::BeginSearch(const FText& InSearchText, const ESearchCase::Type InSearchCase, const bool InReverse)
{
...
void FChunrealSlateEditableTextLayout::AdvanceSearch(const bool InReverse)
{
...
UE::Slate::FDeprecateVector2DResult FChunrealSlateEditableTextLayout::SetHorizontalScrollFraction(const float InScrollOffsetFraction)
{
	ScrollOffset.X = FMath::Clamp<float>(InScrollOffsetFraction, 0.0, 1.0) * TextLayout->GetSize().X;
	return ScrollOffset;
}

UE::Slate::FDeprecateVector2DResult FChunrealSlateEditableTextLayout::SetVerticalScrollFraction(const float InScrollOffsetFraction)
{
	ScrollOffset.Y = FMath::Clamp<float>(InScrollOffsetFraction, 0.0, 1.0) * TextLayout->GetSize().Y;
	return ScrollOffset;
}

UE::Slate::FDeprecateVector2DResult FChunrealSlateEditableTextLayout::SetScrollOffset(const UE::Slate::FDeprecateVector2DParameter& InScrollOffset, const FGeometry& InGeometry)
{
...
UE::Slate::FDeprecateVector2DResult FChunrealSlateEditableTextLayout::GetScrollOffset() const
{
	return ScrollOffset;
}


float FChunrealSlateEditableTextLayout::GetComputedWrappingWidth() const
{
	return TextLayout->GetWrappingWidth();
}

bool FChunrealSlateEditableTextLayout::GetAutoWrapText() const
{
	return AutoWrapText.Get();
}

bool FChunrealSlateEditableTextLayout::HandleFocusReceived(const FFocusEvent& InFocusEvent)
{
	if (ActiveContextMenu.IsValid())
	{
		return false;
	...
	if (FPlatformApplicationMisc::RequiresVirtualKeyboard())
	{
		...
		{
			if ( (InFocusEvent.GetCause() == EFocusCause::Mouse && OwnerWidget->GetVirtualKeyboardTrigger() == EChunrealVirtualKeyboardTrigger::OnFocusByPointer) ||
				 (OwnerWidget->GetVirtualKeyboardTrigger() == EChunrealVirtualKeyboardTrigger::OnAllFocusEvents))
			{
	...
	{
		GoTo(EChunrealTextLocation::EndOfDocument);
	}
...
bool FChunrealSlateEditableTextLayout::HandleFocusLost(const FFocusEvent& InFocusEvent)
{
	if (ActiveContextMenu.IsValid())
	{
		return false;
...
FReply FChunrealSlateEditableTextLayout::HandleKeyChar(const FCharacterEvent& InCharacterEvent)
{
...
FReply FChunrealSlateEditableTextLayout::HandleKeyDown(const FKeyEvent& InKeyEvent)
{
	...
	if (Key == EKeys::Left)
	{
		if (OwnerWidget->IsTextPassword() && InKeyEvent.IsControlDown())
		{
			...
			JumpTo(EChunrealTextLocation::BeginningOfLine, InKeyEvent.IsShiftDown() ? EChunrealCursorAction::SelectText : EChunrealCursorAction::MoveCursor);
			Reply = FReply::Handled();
		}
		else
		{
			Reply = BoolToReply(MoveCursor(FChunrealMoveCursor::Cardinal(
				// Ctrl moves a whole word instead of one character.	
				InKeyEvent.IsControlDown() ? EChunrealCursorMoveGranularity::Word : EChunrealCursorMoveGranularity::Character,
				// Move left
				FIntPoint(-1, 0),
				// Shift selects text.	
				InKeyEvent.IsShiftDown() ? EChunrealCursorAction::SelectText : EChunrealCursorAction::MoveCursor
			)));
		}
	}
	else if (Key == EKeys::Right)
	{
		...
		{
			// If the text is sensitive, we should not clue the user in to where word breaks are
			JumpTo(EChunrealTextLocation::EndOfLine, InKeyEvent.IsShiftDown() ? EChunrealCursorAction::SelectText : EChunrealCursorAction::MoveCursor);
			Reply = FReply::Handled();
		}
		else
		{
	...
	{
		Reply = BoolToReply(MoveCursor(FChunrealMoveCursor::Cardinal(
			EChunrealCursorMoveGranularity::Character,
			// Move up
			FIntPoint(0, -1),
			// Shift selects text.	
			InKeyEvent.IsShiftDown() ? EChunrealCursorAction::SelectText : EChunrealCursorAction::MoveCursor
	...
	else if (Key == EKeys::Home)
	{
		...
		JumpTo(
			(InKeyEvent.IsControlDown()) ? EChunrealTextLocation::BeginningOfDocument : EChunrealTextLocation::BeginningOfLine,
			(InKeyEvent.IsShiftDown()) ? EChunrealCursorAction::SelectText : EChunrealCursorAction::MoveCursor);
		Reply = FReply::Handled();
	}
	else if (Key == EKeys::End)
	{
		...
		JumpTo(
			(InKeyEvent.IsControlDown()) ? EChunrealTextLocation::EndOfDocument : EChunrealTextLocation::EndOfLine,
			(InKeyEvent.IsShiftDown()) ? EChunrealCursorAction::SelectText : EChunrealCursorAction::MoveCursor);
		Reply = FReply::Handled();
	}
	else if (Key == EKeys::PageUp)
	{
		...
		JumpTo(
			EChunrealTextLocation::PreviousPage,
			(InKeyEvent.IsShiftDown()) ? EChunrealCursorAction::SelectText : EChunrealCursorAction::MoveCursor);
		Reply = FReply::Handled();
	}
	else if (Key == EKeys::PageDown)
	{
		...
		JumpTo(
			EChunrealTextLocation::NextPage,
			(InKeyEvent.IsShiftDown()) ? EChunrealCursorAction::SelectText : EChunrealCursorAction::MoveCursor);
		Reply = FReply::Handled();
	}
	...
	else if (Key == EKeys::Delete && !OwnerWidget->IsTextReadOnly())
	{
		...
		if (!AnyTextSelected() && InKeyEvent.IsControlDown() && !InKeyEvent.IsAltDown() && !InKeyEvent.IsShiftDown())
		{
			...
			{
				// If the text is sensitive, we should not clue the user in to where word breaks are
				JumpTo(EChunrealTextLocation::EndOfLine, EChunrealCursorAction::SelectText);
			}
			else
			{
				MoveCursor(FChunrealMoveCursor::Cardinal(
					EChunrealCursorMoveGranularity::Word,
					// Move right
					FIntPoint(+1, 0),
					// selects text.	
					EChunrealCursorAction::SelectText
				));
			}
		}
	...
	else if (Key == EKeys::BackSpace && InKeyEvent.IsControlDown() && !InKeyEvent.IsAltDown() && !InKeyEvent.IsShiftDown() && !OwnerWidget->IsTextReadOnly())
	{
		...
		{
			// If the text is sensitive, we should not clue the user in to where word breaks are
			JumpTo(EChunrealTextLocation::BeginningOfLine, EChunrealCursorAction::SelectText);
		}
		else
		{
			MoveCursor(FChunrealMoveCursor::Cardinal(
...
FReply FChunrealSlateEditableTextLayout::HandleKeyUp(const FKeyEvent& InKeyEvent)
{
...
FReply FChunrealSlateEditableTextLayout::HandleMouseButtonDown(const FGeometry& MyGeometry, const FPointerEvent& InMouseEvent)
{
	FReply Reply = FReply::Unhandled();
	...
	if (!OwnerWidget->GetSlateWidget()->HasMouseCapture())
	{
			...
			InMouseEvent.GetEffectingButton() == EKeys::RightMouseButton)
		{
			...
			if (InMouseEvent.GetEffectingButton() == EKeys::LeftMouseButton)
			{
				...
				{
					MoveCursor(FChunrealMoveCursor::ViaScreenPointer(MyGeometry.AbsoluteToLocal(InMouseEvent.GetScreenSpacePosition()), MyGeometry.Scale, EChunrealCursorAction::SelectText));
				}
				else
				{
					// Deselect any text that was selected
					ClearSelection();
					MoveCursor(FChunrealMoveCursor::ViaScreenPointer(MyGeometry.AbsoluteToLocal(InMouseEvent.GetScreenSpacePosition()), MyGeometry.Scale, EChunrealCursorAction::MoveCursor));
				}
...
FReply FChunrealSlateEditableTextLayout::HandleMouseButtonUp(const FGeometry& MyGeometry, const FPointerEvent& InMouseEvent)
{
	FReply Reply = FReply::Unhandled();
			...
			InMouseEvent.GetEffectingButton() == EKeys::RightMouseButton)
		{
			if (!bWasFocusedByLastMouseDown)
			{
				...
				if (FPlatformApplicationMisc::RequiresVirtualKeyboard())
				{
					if (!OwnerWidget->IsTextReadOnly())
					{
						if (OwnerWidget->GetVirtualKeyboardTrigger() == EChunrealVirtualKeyboardTrigger::OnAllFocusEvents ||
							OwnerWidget->GetVirtualKeyboardTrigger() == EChunrealVirtualKeyboardTrigger::OnFocusByPointer)
						{
		...
		else if (InMouseEvent.GetEffectingButton() == EKeys::RightMouseButton)
		{
			if (MyGeometry.IsUnderLocation(InMouseEvent.GetScreenSpacePosition()))
			{
				...
				if (MenuContentWidget.IsValid())
				{
					...
					{
						ContextMenu->GetOnMenuDismissed().AddRaw(this, &FChunrealSlateEditableTextLayout::OnContextMenuClosed);
...
FReply FChunrealSlateEditableTextLayout::HandleMouseMove(const FGeometry& InMyGeometry, const FPointerEvent& InMouseEvent)
{
	if (bIsDragSelecting && OwnerWidget->GetSlateWidget()->HasMouseCapture() && InMouseEvent.GetCursorDelta() != FVector2f::ZeroVector)
	{
		MoveCursor(FChunrealMoveCursor::ViaScreenPointer(InMyGeometry.AbsoluteToLocal(InMouseEvent.GetScreenSpacePosition()), InMyGeometry.Scale, EChunrealCursorAction::SelectText));
...
FReply FChunrealSlateEditableTextLayout::HandleMouseButtonDoubleClick(const FGeometry& InMyGeometry, const FPointerEvent& InMouseEvent)
{
...
bool FChunrealSlateEditableTextLayout::HandleEscape()
{
	if (!SearchText.IsEmpty())
	{
		// Clear search
...
bool FChunrealSlateEditableTextLayout::HandleBackspace()
{
	if (OwnerWidget->IsTextReadOnly())
	{
		return false;
...
bool FChunrealSlateEditableTextLayout::HandleDelete()
{
	if (OwnerWidget->IsTextReadOnly())
	{
		return false;
...
bool FChunrealSlateEditableTextLayout::HandleTypeChar(const TCHAR InChar)
{
	if (OwnerWidget->IsTextReadOnly())
	{
		return false;
...
bool FChunrealSlateEditableTextLayout::HandleCarriageReturn(bool isRepeat)
{
	if (OwnerWidget->IsTextReadOnly())
	{
		return false;
...
bool FChunrealSlateEditableTextLayout::CanExecuteDelete() const
{
...
void FChunrealSlateEditableTextLayout::DeleteSelectedText()
{
	if (OwnerWidget->IsTextReadOnly())
	{
		return;
...
bool FChunrealSlateEditableTextLayout::AnyTextSelected() const
{
	const FTextLocation CursorInteractionPosition = CursorInfo.GetCursorInteractionLocation();
...
bool FChunrealSlateEditableTextLayout::IsTextSelectedAt(const FGeometry& MyGeometry, const UE::Slate::FDeprecateVector2DParameter& ScreenSpacePosition) const
{
...
bool FChunrealSlateEditableTextLayout::IsTextSelectedAt(const UE::Slate::FDeprecateVector2DParameter& InLocalPosition) const
{
	const FTextLocation CursorInteractionPosition = CursorInfo.GetCursorInteractionLocation();
	const FTextLocation SelectionPosition = SelectionStart.Get(CursorInteractionPosition);
...
bool FChunrealSlateEditableTextLayout::CanExecuteSelectAll() const
{
	return true;
}

void FChunrealSlateEditableTextLayout::SelectAllText()
{
...
void FChunrealSlateEditableTextLayout::SelectWordAt(const FGeometry& MyGeometry, const UE::Slate::FDeprecateVector2DParameter& ScreenSpacePosition)
{
	const FVector2f LocalPosition = MyGeometry.AbsoluteToLocal(ScreenSpacePosition);
...
void FChunrealSlateEditableTextLayout::ClearSelection()
{
	SelectionStart = TOptional<FTextLocation>();
}

bool FChunrealSlateEditableTextLayout::CanExecuteCut() const
{
	bool bCanExecute = true;
...
void FChunrealSlateEditableTextLayout::CutSelectedTextToClipboard()
{
...
bool FChunrealSlateEditableTextLayout::CanExecuteCopy() const
{
	bool bCanExecute = true;
...
void FChunrealSlateEditableTextLayout::CopySelectedTextToClipboard()
{
	if (OwnerWidget->IsTextPassword())
	{
		return;
...
bool FChunrealSlateEditableTextLayout::CanExecutePaste() const
{
	bool bCanExecute = true;
...
void FChunrealSlateEditableTextLayout::PasteTextFromClipboard()
{
	if (OwnerWidget->IsTextReadOnly())
	{
		return;
...
void FChunrealSlateEditableTextLayout::InsertTextAtCursor(const FString& InString)
{
	if (OwnerWidget->IsTextReadOnly())
	{
		return;
...
void FChunrealSlateEditableTextLayout::InsertTextAtCursorImpl(const FString& InString)
{
...
void FChunrealSlateEditableTextLayout::InsertNewLineAtCursorImpl()
{
...
TSharedRef<IRun> FChunrealSlateEditableTextLayout::CreateTextOrPasswordRun(const FRunInfo& InRunInfo, const TSharedRef<const FString>& InText, const FTextBlockStyle& InStyle)
{
	if (OwnerWidget->IsTextPassword())
	{
...
void FChunrealSlateEditableTextLayout::OnContextMenuClosed(TSharedRef<IMenu> Menu)
{
...
void FChunrealSlateEditableTextLayout::InsertRunAtCursor(TSharedRef<IRun> InRun)
{
	if (OwnerWidget->IsTextReadOnly())
	{
		return;
...
bool FChunrealSlateEditableTextLayout::MoveCursor(const FChunrealMoveCursor& InArgs)
{
	...
	if (!FSlateApplication::Get().AllowMoveCursor() ||
		(TextInputMethodContext->IsComposing() && InArgs.GetMoveMethod() != EChunrealCursorMoveMethod::ScreenPosition))
	{
	...
	if (InArgs.GetAction() == EChunrealCursorAction::MoveCursor && InArgs.GetMoveMethod() != EChunrealCursorMoveMethod::ScreenPosition && AnyTextSelected())
	{
		...
		bool bSnapToSelectionStart =
			InArgs.GetMoveMethod() == EChunrealCursorMoveMethod::Cardinal &&
		...
		if (InArgs.GetGranularity() == EChunrealCursorMoveGranularity::Word && IsAtWordStart(NewCursorPosition))
		{
			bAllowMoveCursor = false;
		}
	}
	...
	if (bAllowMoveCursor)
	{
		if (InArgs.GetMoveMethod() == EChunrealCursorMoveMethod::Cardinal)
		{
			if (InArgs.GetGranularity() == EChunrealCursorMoveGranularity::Character)
			{
				if (InArgs.IsHorizontalMovement())
				{
			...
			else
			{
				...
				checkSlow(InArgs.GetGranularity() == EChunrealCursorMoveGranularity::Word);
				checkSlow(InArgs.GetMoveDirection().X != 0);
				NewCursorPosition = ScanForWordBoundary(CursorPosition, InArgs.GetMoveDirection().X);
				bUpdatePreferredCursorScreenOffsetInLine = true;
			}
		}
		else if (InArgs.GetMoveMethod() == EChunrealCursorMoveMethod::ScreenPosition)
		{
	...
	if (InArgs.GetAction() == EChunrealCursorAction::SelectText)
	{
...
void FChunrealSlateEditableTextLayout::GoTo(const FTextLocation& NewLocation)
{
	const TArray< FTextLayout::FLineModel >& Lines = TextLayout->GetLineModels();
...
void FChunrealSlateEditableTextLayout::GoTo(EChunrealTextLocation NewLocation)
{
	JumpTo(NewLocation, EChunrealCursorAction::MoveCursor);
}

void FChunrealSlateEditableTextLayout::JumpTo(EChunrealTextLocation JumpLocation, EChunrealCursorAction Action)
{
	...
	switch (JumpLocation)
	{
	case EChunrealTextLocation::BeginningOfLine:
		{
			const FTextLocation CursorInteractionPosition = CursorInfo.GetCursorInteractionLocation();
			...
			if (LineViews.IsValidIndex(CurrentLineViewIndex))
			{
				...
				if (Action == EChunrealCursorAction::SelectText)
				{
					if (!SelectionStart.IsSet())
					{
	...
	case EChunrealTextLocation::BeginningOfDocument:
		{
	...
	case EChunrealTextLocation::EndOfLine:
		{
			const FTextLocation CursorInteractionPosition = CursorInfo.GetCursorInteractionLocation();
			const TArray< FTextLayout::FLineView >& LineViews = TextLayout->GetLineViews();
			const int32 CurrentLineViewIndex = TextLayout->GetLineViewIndexForTextLocation(LineViews, CursorInteractionPosition, CursorInfo.GetCursorAlignment() == SlateEditableTextTypes::ECursorAlignment::Right);
	...
	case EChunrealTextLocation::EndOfDocument:
		{
			if (!TextLayout->IsEmpty())
			{
				const FTextLocation OldCursorPosition = CursorInfo.GetCursorInteractionLocation();
	...
	case EChunrealTextLocation::PreviousPage:
		{
			const FTextLocation CursorInteractionPosition = CursorInfo.GetCursorInteractionLocation();
			const TArray< FTextLayout::FLineView >& LineViews = TextLayout->GetLineViews();
			const int32 CurrentLineViewIndex = TextLayout->GetLineViewIndexForTextLocation(LineViews, CursorInteractionPosition, CursorInfo.GetCursorAlignment() == SlateEditableTextTypes::ECursorAlignment::Right);
	...
	case EChunrealTextLocation::NextPage:
		{
			const FTextLocation CursorInteractionPosition = CursorInfo.GetCursorInteractionLocation();
			const TArray< FTextLayout::FLineView >& LineViews = TextLayout->GetLineViews();
			const int32 CurrentLineViewIndex = TextLayout->GetLineViewIndexForTextLocation(LineViews, CursorInteractionPosition, CursorInfo.GetCursorAlignment() == SlateEditableTextTypes::ECursorAlignment::Right);
...
void FChunrealSlateEditableTextLayout::ScrollTo(const FTextLocation& NewLocation)
{
	const TArray< FTextLayout::FLineModel >& Lines = TextLayout->GetLineModels();
	if (Lines.IsValidIndex(NewLocation.GetLineIndex()))
	{
...
void FChunrealSlateEditableTextLayout::ScrollTo(const EChunrealTextLocation NewLocation)
{
	const TArray< FTextLayout::FLineModel >& Lines = TextLayout->GetLineModels();
...
void FChunrealSlateEditableTextLayout::UpdateCursorHighlight()
{
...
void FChunrealSlateEditableTextLayout::RemoveCursorHighlight()
{
	const TArray<FTextLayout::FLineModel>& Lines = TextLayout->GetLineModels();
...
void FChunrealSlateEditableTextLayout::UpdatePreferredCursorScreenOffsetInLine()
{
...
void FChunrealSlateEditableTextLayout::ApplyToSelection(const FRunInfo& InRunInfo, const FTextBlockStyle& InStyle)
{
	if (OwnerWidget->IsTextReadOnly())
	{
		return;
...
TSharedPtr<const IRun> FChunrealSlateEditableTextLayout::GetRunUnderCursor() const
{
	const TArray<FTextLayout::FLineModel>& Lines = TextLayout->GetLineModels();
...
TArray<TSharedRef<const IRun>> FChunrealSlateEditableTextLayout::GetSelectedRuns() const
{
...
FTextLocation FChunrealSlateEditableTextLayout::GetCursorLocation() const
{
	return CursorInfo.GetCursorInteractionLocation();
}

FTextLocation FChunrealSlateEditableTextLayout::TranslatedLocation(const FTextLocation& Location, int8 Direction) const
{
	check(Direction != 0);
...
void FChunrealSlateEditableTextLayout::TranslateLocationVertical(const FTextLocation& Location, int32 NumLinesToMove, float GeometryScale, FTextLocation& OutCursorPosition, TOptional<SlateEditableTextTypes::ECursorAlignment>& OutCursorAlignment) const
{
	const TArray< FTextLayout::FLineView >& LineViews = TextLayout->GetLineViews();
...
FTextLocation FChunrealSlateEditableTextLayout::ScanForWordBoundary(const FTextLocation& CurrentLocation, int8 Direction) const
{
...
TCHAR FChunrealSlateEditableTextLayout::GetCharacterAt(const FTextLocation& Location) const
{
	const TArray< FTextLayout::FLineModel >& Lines = TextLayout->GetLineModels();
...
bool FChunrealSlateEditableTextLayout::IsAtBeginningOfDocument(const FTextLocation& Location) const
{
	return Location.GetLineIndex() == 0 && Location.GetOffset() == 0;
}

bool FChunrealSlateEditableTextLayout::IsAtEndOfDocument(const FTextLocation& Location) const
{
	const TArray< FTextLayout::FLineModel >& Lines = TextLayout->GetLineModels();
	const int32 NumberOfLines = Lines.Num();
...
bool FChunrealSlateEditableTextLayout::IsAtBeginningOfLine(const FTextLocation& Location) const
{
	return Location.GetOffset() == 0;
}

bool FChunrealSlateEditableTextLayout::IsAtEndOfLine(const FTextLocation& Location) const
{
	const TArray< FTextLayout::FLineModel >& Lines = TextLayout->GetLineModels();
	return Lines[Location.GetLineIndex()].Text->Len() == Location.GetOffset();
}

bool FChunrealSlateEditableTextLayout::IsAtWordStart(const FTextLocation& Location) const
{
...
void FChunrealSlateEditableTextLayout::RestoreOriginalText()
{
...
bool FChunrealSlateEditableTextLayout::HasTextChangedFromOriginal() const
{
...
void FChunrealSlateEditableTextLayout::BeginEditTransation()
{
...
void FChunrealSlateEditableTextLayout::EndEditTransaction()
{
	NumTransactionsOpened -= 1;
...
void FChunrealSlateEditableTextLayout::PushUndoState(const SlateEditableTextTypes::FUndoState& InUndoState)
{
...
void FChunrealSlateEditableTextLayout::ClearUndoStates()
{
	CurrentUndoLevel = INDEX_NONE;
	UndoStates.Empty();
}

void FChunrealSlateEditableTextLayout::MakeUndoState(SlateEditableTextTypes::FUndoState& OutUndoState)
{
...
bool FChunrealSlateEditableTextLayout::CanExecuteUndo() const
{
...
void FChunrealSlateEditableTextLayout::Undo()
{
...
bool FChunrealSlateEditableTextLayout::CanExecuteRedo() const
{
...
void FChunrealSlateEditableTextLayout::Redo()
{
...
void FChunrealSlateEditableTextLayout::SaveText(const FText& TextToSave)
{
...
void FChunrealSlateEditableTextLayout::LoadText()
{
...
bool FChunrealSlateEditableTextLayout::ComputeVolatility() const
{
...
void FChunrealSlateEditableTextLayout::Tick(const FGeometry& AllottedGeometry, const double InCurrentTime, const float InDeltaTime)
{
...
int32 FChunrealSlateEditableTextLayout::OnPaint(const FPaintArgs& Args, const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FWidgetStyle& InWidgetStyle, bool bParentEnabled)
{
...
FVector2D FChunrealSlateEditableTextLayout::ComputeDesiredSize(float LayoutScaleMultiplier) const
{
	check(IsInGameThread());
...
FChildren* FChunrealSlateEditableTextLayout::GetChildren()
{
...
void FChunrealSlateEditableTextLayout::OnArrangeChildren(const FGeometry& AllottedGeometry, FArrangedChildren& ArrangedChildren) const
{
...
UE::Slate::FDeprecateVector2DResult FChunrealSlateEditableTextLayout::GetSize() const
{
	return UE::Slate::CastToVector2f(TextLayout->GetSize());
}

TSharedRef<SWidget> FChunrealSlateEditableTextLayout::BuildDefaultContextMenu(const TSharedPtr<FExtender>& InMenuExtender) const
{
...
bool FChunrealSlateEditableTextLayout::HasActiveContextMenu() const
{
	return ActiveContextMenu.IsValid();
}

void FChunrealSlateEditableTextLayout::GetCurrentTextLine(FString& OutTextLine) const
{	
	// grab line of text
...
void FChunrealSlateEditableTextLayout::GetTextLine(const int32 InLineIndex, FString& OutTextLine) const
{
	const TArray< FTextLayout::FLineModel >& Lines = TextLayout->GetLineModels();
...
TSharedRef<FChunrealSlateEditableTextLayout::FVirtualKeyboardEntry> FChunrealSlateEditableTextLayout::FVirtualKeyboardEntry::Create(FChunrealSlateEditableTextLayout& InOwnerLayout)
{
	return MakeShareable(new FVirtualKeyboardEntry(InOwnerLayout));
}

FChunrealSlateEditableTextLayout::FVirtualKeyboardEntry::FVirtualKeyboardEntry(FChunrealSlateEditableTextLayout& InOwnerLayout)
	: OwnerLayout(&InOwnerLayout)
{
}

void FChunrealSlateEditableTextLayout::FVirtualKeyboardEntry::SetTextFromVirtualKeyboard(const FText& InNewText, ETextEntryType TextEntryType)
{
	check(IsInGameThread());
	...
	{
		if (OwnerLayout->OwnerWidget->GetVirtualKeyboardDismissAction() == EChunrealVirtualKeyboardDismissAction::TextCommitOnAccept ||
			OwnerLayout->OwnerWidget->GetVirtualKeyboardDismissAction() == EChunrealVirtualKeyboardDismissAction::TextCommitOnDismiss)
		{
	...
	{
		if (OwnerLayout->OwnerWidget->GetVirtualKeyboardDismissAction() == EChunrealVirtualKeyboardDismissAction::TextCommitOnDismiss)
		{
...
void FChunrealSlateEditableTextLayout::FVirtualKeyboardEntry::SetSelectionFromVirtualKeyboard(int InSelStart, int InSelEnd)
{
	check(IsInGameThread());
...
FText FChunrealSlateEditableTextLayout::FVirtualKeyboardEntry::GetText() const
{
	check(IsInGameThread());
...
bool FChunrealSlateEditableTextLayout::FVirtualKeyboardEntry::GetSelection(int& OutSelStart, int& OutSelEnd)
{
	check(IsInGameThread());
...
FText FChunrealSlateEditableTextLayout::FVirtualKeyboardEntry::GetHintText() const
{
	check(IsInGameThread());
...
EKeyboardType FChunrealSlateEditableTextLayout::FVirtualKeyboardEntry::GetVirtualKeyboardType() const
{
	check(IsInGameThread());
...
FVirtualKeyboardOptions FChunrealSlateEditableTextLayout::FVirtualKeyboardEntry::GetVirtualKeyboardOptions() const
{
	check(IsInGameThread());
...
bool FChunrealSlateEditableTextLayout::FVirtualKeyboardEntry::IsMultilineEntry() const
{
	check(IsInGameThread());
...
TSharedRef<FChunrealSlateEditableTextLayout::FTextInputMethodContext> FChunrealSlateEditableTextLayout::FTextInputMethodContext::Create(FChunrealSlateEditableTextLayout& InOwnerLayout)
{
	return MakeShareable(new FTextInputMethodContext(InOwnerLayout));
}

FChunrealSlateEditableTextLayout::FTextInputMethodContext::FTextInputMethodContext(FChunrealSlateEditableTextLayout& InOwnerLayout)
	: OwnerLayout(&InOwnerLayout)
	, bIsComposing(false)
...
bool FChunrealSlateEditableTextLayout::FTextInputMethodContext::IsComposing()
{
	return OwnerLayout && bIsComposing;
}

bool FChunrealSlateEditableTextLayout::FTextInputMethodContext::IsReadOnly()
{
	return !OwnerLayout || OwnerLayout->OwnerWidget->IsTextReadOnly();
}

uint32 FChunrealSlateEditableTextLayout::FTextInputMethodContext::GetTextLength()
{
	if (!OwnerLayout)
	{
		return 0;
...
void FChunrealSlateEditableTextLayout::FTextInputMethodContext::GetSelectionRange(uint32& BeginIndex, uint32& Length, ECaretPosition& OutCaretPosition)
{
	if (!OwnerLayout)
	{
		BeginIndex = 0;
...
void FChunrealSlateEditableTextLayout::FTextInputMethodContext::SetSelectionRange(const uint32 BeginIndex, const uint32 Length, const ECaretPosition InCaretPosition)
{
	if (!OwnerLayout)
	{
		return;
...
void FChunrealSlateEditableTextLayout::FTextInputMethodContext::GetTextInRange(const uint32 BeginIndex, const uint32 Length, FString& OutString)
{
	if (!OwnerLayout)
	{
		OutString.Reset();
...
void FChunrealSlateEditableTextLayout::FTextInputMethodContext::SetTextInRange(const uint32 BeginIndex, const uint32 Length, const FString& InString)
{
	if (!OwnerLayout)
	{
		return;
...
int32 FChunrealSlateEditableTextLayout::FTextInputMethodContext::GetCharacterIndexFromPoint(const FVector2D& Point)
{
	if (!OwnerLayout)
	{
		return INDEX_NONE;
...
bool FChunrealSlateEditableTextLayout::FTextInputMethodContext::GetTextBounds(const uint32 BeginIndex, const uint32 Length, FVector2D& Position, FVector2D& Size)
{
	if (!OwnerLayout)
	{
...
void FChunrealSlateEditableTextLayout::FTextInputMethodContext::GetScreenBounds(FVector2D& Position, FVector2D& Size)
{
	if (!OwnerLayout)
	{
		Position = FVector2D::ZeroVector;
...
void FChunrealSlateEditableTextLayout::FTextInputMethodContext::CacheWindow()
{
	if (!OwnerLayout)
	{
		return;
...
TSharedPtr<FGenericWindow> FChunrealSlateEditableTextLayout::FTextInputMethodContext::GetWindow()
{
	if (!OwnerLayout)
	{
		return nullptr;
...
void FChunrealSlateEditableTextLayout::FTextInputMethodContext::BeginComposition()
{
	if (!OwnerLayout)
	{
		return;
...
void FChunrealSlateEditableTextLayout::FTextInputMethodContext::UpdateCompositionRange(const int32 InBeginIndex, const uint32 InLength)
{
	if (!OwnerLayout)
	{
		return;
...
void FChunrealSlateEditableTextLayout::FTextInputMethodContext::EndComposition()
{
	if (!OwnerLayout)
	{
		return;
