...
//-----------------------------------------------------------------------------
void Chuck_Namespace::add_type( const std::string & xid, Chuck_Type * in_type )
{
    // log it
    EM_log( CK_LOG_DEBUG, "namespace '%s' adding type '%s'->'%s'", this->name.c_str(), xid.c_str(), in_type->name().c_str() );
    // add it
    this->type.add( xid, in_type);
}
...
//-----------------------------------------------------------------------------
void Chuck_Namespace::add_value( const std::string & xid, Chuck_Value * in_value )
{
    // log it
    EM_log( CK_LOG_DEBUG, "namespace '%s' adding value '%s'->'%s'", this->name.c_str(), xid.c_str(), in_value->name.c_str() );
    // add it
    this->value.add( xid, in_value);
}
...
// desc: add type to name space
//-----------------------------------------------------------------------------
void Chuck_Namespace::add_func( const std::string & xid, Chuck_Func * in_func )
{
    // log it
    EM_log( CK_LOG_DEBUG, "namespace '%s' adding func '%s'->'%s'", this->name.c_str(), xid.c_str(), in_func->base_name.c_str() );
    // add it
    this->func.add( xid, in_func);
}
